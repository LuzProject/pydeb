# slightly modified ar.py from https://github.com/permasigner/permasigner/blob/main/permasigner/bundled/constrictor/ar.py, credits to the permasigner team and Ben Shaw
